...
function addElements(elemets) {
  for (var _i = 0, _Object$entries = Object.entries(elemets); _i < _Object$entries.length; _i++) {
    var _Object$entries$_i = _slicedToArray(_Object$entries[_i], 2),
        keyu = _Object$entries$_i[0],
...
addElements(cool); //document.querySelector("#c").innerHTML = "FUCK YOU";

big.textContent = "this is BIG";
text.textContent = "this is smol";
