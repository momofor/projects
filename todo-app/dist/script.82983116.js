...
function AddTask() {
  ...
  var createTaskContainer = tasksContainer.appendChild(document.createElement("ul"));
  ...
  for (var i = 0; i < removeBut.length; i++) {
    removeBut[i].onclick = function () {
      var thisCardContainer = this.parentElement;
      thisCardContainer.classList.add("fall");
      thisCardContainer.addEventListener("transitionend", function () {
...
function FilterTasks(e) {
  var taskList = tasksContainer.childNodes;
